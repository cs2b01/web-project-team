...
class PasswordChangeTests(TestCase):
    def setUp(self):
        username = 'rodrigo'
        password = 'secret123'
        user = User.objects.create_user(username=username, email='rodrigo.morales@django.com', password=password)
...
class PasswordChangeTestCase(TestCase):
    ...
    '''
    def setUp(self, data={}):
        self.user = User.objects.create_user(username='rodrigo', email='rodrigo.morales@django.com', password='old_password')
        self.url = reverse('password_change')
        self.client.login(username='rodrigo', password='old_password')
